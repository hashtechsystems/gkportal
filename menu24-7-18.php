<ul class="nav nav-list">
  <li class="<? if($_SERVER['QUERY_STRING']=="action=dashboard"){ ?> active <? } ?> open"> <a href="index.php?action=dashboard"> <i class="menu-icon ace-icon fa"><img src="images/homeh-icon.jpg"  alt=""/> </i> <span class="menu-text"> Dashboard</span> </a> </li>
  <!--<li class="<? if($_SERVER['QUERY_STRING']=="action=customers_list"){ ?> active <? } ?> open"> <a href="index.php?action=customers_list"> <i class="menu-icon ace-icon fa fa-user"></i> <span class="menu-text"> My profile</span> </a> </li>-->
   <li class="<? if($_SERVER['QUERY_STRING']=="action=employee_list"){ ?> active <? } ?> open"> <a href="index.php?action=employee_list"><i class="menu-icon ace-icon fa"> <img src="images/employess-icon.jpg" alt=""/></i> <span class="menu-text"> Manage Employee</span> </a> </li>
   
   <?php
   if($_SESSION['AssignedPOS'] == "MJ Freeway")
   {
   ?>
   <li class="<? if($_SERVER['QUERY_STRING']=="action=product_mj_freeway_list"){ ?> active <? } ?> open"> <a href="index.php?action=product_mj_freeway_list"> <i class="menu-icon ace-icon fa "> <img src="images/product-icon.jpg"  alt=""/></i>  <span class="menu-text"> Products</span> </a> </li>
   ...
   {
	?>
   <li class="<? if($_SERVER['QUERY_STRING']=="action=product_treez_list"){ ?> active <? } ?> open"> <a href="index.php?action=product_treez_list"> <i class="menu-icon fa"> <img src="images/product-icon.jpg" alt=""/></i> <span class="menu-text"> Products</span> </a> </li>
   <?php
   }
   else
   ...
   {
	?>
   <li class="<? if($_SERVER['QUERY_STRING']=="action=product_list"){ ?> active <? } ?> "> <a href="index.php?action=product_list"> <i class="menu-icon ace-icon fa "><img src="images/product-icon.jpg"  alt=""/> </i>  <span class="menu-text"> Products</span> </a> </li>
   <li class="<? if($_SERVER['QUERY_STRING']=="action=customer_list_no_pos"){ ?> active <? } ?> "> <a href="index.php?action=customer_list_no_pos"> <i class="menu-icon fa"> <img src="images/consumers-icon.jpg"  alt=""/></i> <span class="menu-text"> Consumers</span> </a> </li>
   <?php
   }
   else
   ...
   {
   ?>
   <li class="<? if($_SERVER['QUERY_STRING']=="action=product_greenbits_list"){ ?> active <? } ?> "> <a href="index.php?action=product_greenbits_list"> <i class="menu-icon fa"> <img src="images/product-icon.jpg" alt=""/></i> <span class="menu-text"> Products</span> </a> </li>
   <li class="<? if($_SERVER['QUERY_STRING']=="action=consumer_list_greenbits"){ ?> active <? } ?> "> <a href="index.php?action=consumer_list_greenbits"> <i class="menu-icon fa"> <img src="images/consumers-icon.jpg"  alt=""/></i> <span class="menu-text"> Consumers</span> </a> </li>
   <?php
   }
   ?>
   <li class="<? if($_SERVER['QUERY_STRING']=="action=manage_planogram"){ ?> active <? } ?> "> <a href="index.php?action=manage_planogram"> <i class="menu-icon fa"> <img src="images/mange-icon.jpg" alt=""/></i> <span class="menu-text"> Manage Planogram</span> </a> </li>
   
   <li class=""> <a class="dropdown-toggle" href="#"> <i class="menu-icon fa"> <img src="images/reports-icon.jpg" alt=""/></i> <span class="menu-text"> Reports </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
