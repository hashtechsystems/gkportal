...
if($_REQUEST['submit'])
{
	...
	if($Error == 0)
	{
		mysql_query("UPDATE `mj_freeway_products` SET `name`='".$_REQUEST['name']."',`description`='".$_REQUEST['description']."',`category_name`='".$_REQUEST['category_name']."',`row`='".$_REQUEST['row']."',`col`='".$_REQUEST['col']."',`strain_name`='".$_REQUEST['strain_name']."',`default_price`='".$_REQUEST['default_price']."',`discount`='".$_REQUEST['discount']."',`gm`='".$_REQUEST['gm']."',`ounce`='".$_REQUEST['ounce']."',`thc`='".$_REQUEST['thc']."' , `featured` = '".mysql_real_escape_string($featured)."', `new` = '".mysql_real_escape_string($new)."', `popular` = '".mysql_real_escape_string($popular)."' WHERE id='".$_REQUEST['id']."'");	
...
<div class="page-header tbg2" style="margin-top:20px;">
 <div class="col-md-8">
  ...
  <div class="col-md-4" style="text-align:right;"> <a href="index.php?action=product_mj_freeway_list" class="greenbtn1">Previous Page</a> </div>
</div>
<div>
  ...
  <div class="col-md-8">
                              ...
                              <div class="w100">
                                ...
                                <input type="hidden" name="id" value="<?=$data['id'];?>">
                                  <input class="textbox6" type="text" name="name" value="<?=$data['name'];?>">
								  &nbsp;
...
-->						  
							<div class="clearfix gap1"> </div>
                             <div class="w100">
                                ...
                                <div class="col-md-12">
                                <input class="textbox6" type="text" name="category_name" value="<?=$data['category_name'];?>">
                                </div>
                             </div>
							...
							<div class="clearfix gap1"> </div>
                              <div class="w100">
                                ...
                                <div class="col-md-12">
                                <input class="textbox6" type="text" name="default_price" value="<?=$data['default_price'];?>">
                                </div>
                              </div>
							...
							<div class="clearfix gap1"> </div>
                              <div class="w100">
                                ...
                                <div class="col-md-12">
								<input class="textbox6" type="text" name="thc" value="<?=$data['thc'];?>">
                                </div>
                              </div>
