...
<div class="col-md-8">
  ...
  <div class="col-md-4" style="text-align:right;"><a href="index.php?action=product_list=<?=$_REQUEST['page'];?>&ipp=<?=$_REQUEST['ipp'];?>" class="greenbtn1">Previous Page</a> </div>
...
<div class="" id="">
 <form action="" name="kiosk"  method="post" enctype="multipart/form-data">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="table">
                              <tr>
                                <td width="200" align="left" class="form-t">Name</td>
                                <td width="20">:</td>
                              ...
                              <tr align="left">
                                ...
                                <td width="20"></td>
                                <td height="40" colspan=""><input id="cmdCheck" name="btnSubmit" value="Add" type="submit" class="greenbtn2"/>
