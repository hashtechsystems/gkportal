...
if($_REQUEST['submit'])
{
	...
	if(count($error) < 1)
	{
		mysql_query("UPDATE `tbl_groups` SET `name`='".$_REQUEST['name']."',`price`='".$_REQUEST['price']."',`cost`='".$_REQUEST['cost']."',`depth`='".$_REQUEST['depth']."',`par`='".$_REQUEST['par']."'");			
		echo "<script> document.location.href='index.php?action=group_list'</script>";		
	}
}
$getGroupDetails=mysql_fetch_array(mysql_query("SELECT * FROM tbl_groups WHERE `id`='".$_REQUEST['id']."'"));
                        ...
                        <tr>
                          <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="text">
                              <tr>
                                ...
                                <td width="20">:</td>
                                <td height="40" class="textbox-bg2" align="left"><input type="text" name="name" value="<?=$getGroupDetails['name'];?>"></td>
                              </tr>
                              <tr>
                                <td align="left" class="form-t">Price</td>
                                <td width="20">:</td>
                                <td height="40" class="textbox-bg2" align="left"><input type="text" name="price" value="<?=$getGroupDetails['price'];?>"></td>
                              </tr>
                              <tr>
                                <td align="left" class="form-t">Cost</td>
                                <td width="20">:</td>
                                <td height="40" class="textbox-bg2" align="left"><input type="text" name="cost" value="<?=$getGroupDetails['cost'];?>"></td>
                              </tr>
                              <tr>
                                <td align="left" class="form-t">Par</td>
                                <td width="20">:</td>
                                <td height="40" class="textbox-bg2" align="left"><input type="text" name="par" value="<?=$getGroupDetails['par'];?>"></td>
                              </tr>
                              <tr>
                                <td align="left" class="form-t">Depth</td>
                                <td width="20">:</td>
                                <td height="40" class="textbox-bg2" align="left"><input type="text" name="depth" value="<?=$getGroupDetails['depth'];?>"></td>
                              </tr>
                              <tr align="left">
