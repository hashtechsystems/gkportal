...
#		exit();
		mysql_query("INSERT INTO `tbl_users` (`account_id`,`first_name`,`last_name`,`username`,`password`)VALUES('".$_REQUEST['account']."','".$_REQUEST['first_name']."','".$_REQUEST['last_name']."','".$_REQUEST['username']."','".$_REQUEST['password']."')");			
