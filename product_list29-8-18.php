...
<div class="row grybox" style="max-width:99% !important; padding:1%;display: -webkit-box; ">
   ...
   <div class="row" style="max-width:99% !important; padding:1%; display: -webkit-box; margin:0;  ">
	...
	<div class="input-group">
                                                            ...
                                                            <div class="col-md-3"><a href="index.php?action=add_product" style="float:right;"> <img src="images/plus.jpg" width= alt=""/> </a></div>
 ...
 <div class="" style="display: -webkit-box; width:97%; position:relative; margin-top:; margin:-30px auto 0 auto;">
  <table cellpadding="0" cellspacing="0"  align="center" class="table " width="100%">
    ...
    <?php	
	$query=mysql_query("SELECT * FROM `tbl_products` WHERE customer_id = ".$_SESSION['user_id']." $where $orderBy");
	$cnt=0;
