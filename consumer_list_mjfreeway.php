...
function showResult(str) {
  ...
  xmlhttp.open("GET","searchConsumer_mj.php?q="+str,true);
  xmlhttp.send();
}
...
<div class="grybox" style="max-width:98% !important; padding:1%;display: -webkit-box; ">
   ...
   <div class="row" style="max-width:99% !important; padding:1%; display: -webkit-box; margin:0;  ">
    ...
    <div class="col-md-7">
	<form name="search_form" action="index.php?action=consumer_list_mjfreeway" method="post" autocomplete="off">
	<div class="input-group">
                                                                ...
                                                                <div class="col-md-2">
																<form name="sortForm" id="sortForm" action="index.php?action=consumer_list_mjfreeway" method="post">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" align="center" class="table">
    ...
    <?php	
	$query=mysql_query("SELECT consumer_id, first_name, middle_name, last_name, email_address, gender, birth_date, active, total_points, total_orders, total_spent FROM `tbl_consumer_mjfreeway` $where $orderBy");
	$cnt=0;
