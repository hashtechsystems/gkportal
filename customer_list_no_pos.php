...
?>
<div class="grybox rwebkit" style="display: -webkit-box; width:100%; padding:4% 0;">
  ...
  <div class="row" style="width:100% !important; padding:1%; display:-webkit-box;">
  
  
   <div class="clearfix rwebkit" style="display: -webkit-box;"></div>
  
   <div class="row rwebkit" style="max-width:100% !important; padding:1%; display: -webkit-box; margin:0;  ">
	...
	<input name="search_name" id="search_name" type="text" class="form-control search-query" placeholder="search for someone"  style="padding:25px; background:#edf9f5; color:#215b5d; font-size:20px;" value="<?php if(isset($_REQUEST['search_name'])) echo $_REQUEST['search_name'] ?>" onkeyup="showResult(this.value)">
                                                            ...
                                                            <div class="col-md-2 b20"><a href="index.php?action=add_customer_no_pos" style="float:right;"> <img src="images/plus.jpg" width= alt=""/> </a></div>
    
    </div>
  
  </div>
 <div class="tpos" style="display: -webkit-box; width:100%; position:relative; margin:;">
