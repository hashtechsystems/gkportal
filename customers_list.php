...
<div class="" id="container" >
  <div class="" style="max-width:98% !important; padding:1%;display: -webkit-box; "></div>
  <div class="tpos rwebkit" style="display: -webkit-box; width:97%; position:relative; margin:;">
  <table cellpadding="" cellspacing="" width="100%" align="center" class="table">
    ...
    <tr>
	  ...
	  <td> <a href="index.php?action=edit_terms&tid=<?=$data['tid'];?>"><img src="images/terms.png"   alt=""/></a></td>
    </tr>
    <?php
	}
	?>
