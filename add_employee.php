...
<div class="col-md-8 p40">
  ...
  <div class="col-md-4 textleft" style="text-align:right;"><a href="index.php?action=employee_list&<?=$_REQUEST['page'];?>&ipp=<?=$_REQUEST['ipp'];?>" class="greenbtn1">Previous Page</a> </div>
...
?>
  ...
  <div class="col-md-8">
                      <?php
							...
							<div class="clearfix gap1"> </div> 							 
                             <div class="w100">
                                <div class="col-md-12 p40"><input id="cmdCheck" name="submit" value="Add" type="submit" class="greenbtn2"/>
