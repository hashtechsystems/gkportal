...
<div class="col-md-8">
  ...
  <div class="col-md-4" style="text-align:right;"><a href="index.php?action=manage_screen&<?=$_REQUEST['page'];?>&ipp=<?=$_REQUEST['ipp'];?>" class="greenbtn1">Previous Page</a> </div>
...
<div class="" id="">
  ...
  <div class="col-md-8">
                              ...
                              <div class="w100">
								...
								<div class="col-md-8">
                                	<label for="screenVid"><img src="images/upload.jpg" alt=""/></label>
									<br>
