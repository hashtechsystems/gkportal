...
<div class="row rwebkit" style="max-width:100% !important; padding:1%; display: -webkit-box; ">
  
  
   <div class="clearfix" style="display: -webkit-box;"></div>
  
   <div class="rwebkit" style="width:100%;   display: -webkit-box; margin:;  ">
	...
	<div class="input-group">
																...
																<select id="order_by form-field-select-1" name="order_by" class="form-control" style="border:solid 4px #1dc19c;color:#1dc19c;height: 51px; text-transform:uppercase; font-weight:bold;" onchange="javascript: sortForm.submit();">
                                                            ...
                                                            <div class="col-md-2 b20"><a href="index.php?action=add_employee" style="float:right;"> <img src="images/plus.jpg" width= alt=""/> </a></div>
    
    </div>
  
  </div>
  
  <div class="tpos" style="display: -webkit-box; width:100%; position:relative; margin-top:; margin:auto;">
