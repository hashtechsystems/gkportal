...
<html lang="en">
    ...
    <div class="textcenter nobg" style="border-bottom:solid 1px #fff; background-color: #fff !important; background:url(images/login.jpg) no-repeat center top; height: 118px;">
