...
if (strlen($q)>0) {
  ...
  $sql = mysql_query("SELECT first_name, last_name FROM `tbl_greenbits_customers` WHERE LOWER(first_name) LIKE '%".mysql_real_escape_string(strtolower($q))."%' OR LOWER(last_name) LIKE '%".mysql_real_escape_string(strtolower($q))."%'");
